...
public class Veevapublish {
    ...
    public List<apiPojo.apiReq.Publish.login_expr> getLogin_expr() {
        return login_expr;
    }

    public void setLogin_expr(List<apiPojo.apiReq.Publish.login_expr> login_expr) {
